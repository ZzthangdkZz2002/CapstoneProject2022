        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" >
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" value="${auth != null ? auth.phone : "" }" ${auth != null ? "readonly" : "" } name="phone" id="phone" placeholder="123-45-678" pattern="(((\+|)84)|0)(3|5|7|8|9)+([0-9]{8})\b" required>
                </div>
                ...
                <hr class="mb-4">
                <button class="btn btn-primary btn-lg btn-block text-light" onclick="OrderAction()" >Thanh toán</button>
            </form>
        </div>
    </div>
</div>
