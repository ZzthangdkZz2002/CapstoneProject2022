          ...
          <div class="account">
            ...
            <div class="account_content">
              <div id="order_tabs">
                ...
                <a href="${pageContext.request.contextPath}/order/waiting" style="color: white; background-color: #01447e;">Chờ xác nhận</a>
                                ...
                                <div class="an-order">
                                    <table>
                                        <tr>
                                            ...
                                            <td style="color: #E1DB0A; font-size: 2rem" >${order.status}</td>
                                        </tr>
