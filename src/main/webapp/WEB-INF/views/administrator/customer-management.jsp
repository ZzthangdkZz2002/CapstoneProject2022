                    ...
                    <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0"
                        ...
                        <c:forEach var="customer" items="${customers}">
                            <tr>
                                ...
                                <td>${customer.ward}</td>
                                <td class="currency-text">${customer.totalPaid}</td>
                                <td>
                                    <a href="${pageContext.request.contextPath}/admin/customer/viewOrder?id=${customer.id}" class="btn btn-primary btn-sm edit" type="button" title="Chi tiết"><i
