...
<%--                  <td>${product.available}</td>--%>
                  ...
                  <td>
                    <div class="switch">
                      ...
                      <div style="position:absolute; left:0; right:0; top:0; bottom:0;" onclick="updateProductStatus(this,'${product.id}')"data-toggle="modal"
...
-->
  ...
  <script>
    ...
    function updateProductStatus(e,id){
      var id = id;
