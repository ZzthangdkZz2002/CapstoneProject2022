                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                                <a class="btn btn-add btn-sm" href="${pageContext.request.contextPath}/admin/accounts/add" title="Thêm"><i
                                        class="fas fa-plus"></i>
                        ...
                        <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0"
                            ...
                            <c:forEach var="account" items="${accounts}">
                                <tr>
                                    ...
                                    <td>${account.phone}</td>
                                    <c:if test="${account.role =='ROLE_EMPLOYEE'}"><td>Nhân viên </td></c:if>
                                    <c:if test="${account.role=='ROLE_MANAGER'}"><td> Quản lí</td></c:if>
                                    <c:if test="${account.role=='ROLE_CUSTOMER'}"><td> Khách hàng</td></c:if>
                                    <td>
                                        <label class="switch">
                                            <input class="status-checkbox" onclick="return false" type="checkbox" data-toggle="modal" data-target="#disableStatus" name="check" checked="">
